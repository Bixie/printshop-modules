...
<div class="grid-block width100 modfooter">
	<?php echo JText::_('MOD_BPS_AANBIEDING_PRIJSINFO'); ?>
	<a href="<?php echo $item->prodLink; ?>" class="button"><span class="buttontext"><?php echo JText::_('MOD_BPS_AANBIEDING_BESTELLEN'); ?></span></a>
</div>
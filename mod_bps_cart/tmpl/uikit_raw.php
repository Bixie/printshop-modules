...
?>
<div class="uk-grid">
	<div class="uk-width-custom" style="width:75px;">
		<a class="uk-button uk-button-mini uk-button-expand" href="<?php echo $cartLink;?>" title="<?php echo JText::_('COM_BIXPRINTSHOP_TO_CART'); ?>">
			<i class="uk-icon-shopping-cart"></i>
		</a>
	</div>
	<div class="uk-width-custom" style="width:200px;">
		<span class="text">
		<?php 
